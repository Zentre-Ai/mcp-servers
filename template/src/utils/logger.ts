 ...
 *
 * IMPORTANT: MCP servers communicate over JSON-RPC via STDIO.
 * Using console.log() will corrupt the protocol stream.
 * This logger writes to stderr to avoid breaking the transport.
 */
