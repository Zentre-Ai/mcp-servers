 ...
 */
server.tool(
  "jira_cloud_sprint_issues",
  {
    sprintId: z.number().describe("Sprint ID (use jira_cloud_get_sprints to find)"),
...
logger.info("Jira Cloud search tools registered");
